...
const GlobalStyles = () => (
  <style type="text/css">{`
    ...
    :root {
      ...
      --accent-color: #E3EEB2;
      --accent-hover: #71C0BB;
      --sidebar-text: #f8fafc; /* A light slate color for readability */
      --border-color: #4E6688;
      --body-bg: #f1f5f9;
    }
    ...
    .app-header h1 {
        font-size: 1.85rem; /* Adjusted font size */
        font-weight: 800;
    ...
    .sidebar .form-control:focus {
      ...
      box-shadow: 0 0 0 0.25rem rgba(227, 238, 178, 0.25);
    }
    ...
    .sidebar .accordion-body .card-title {
      font-size: 1.05rem; /* Adjusted font size */
      font-weight: 700;
      color: white; /* FIX: Reverted color to white */
    }
    .sidebar .accordion-body .card-subtitle {
      font-size: 0.8rem;
      color: #e2e8f0; /* FIX: Reverted color to light grey */
    }
